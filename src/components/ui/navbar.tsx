...
export function Navbar({
  ...
  return (
    <nav
      {...props}
      className={twMerge(className, 'flex flex-1 items-center gap-4 py-2.5')}
    />
  )
}
...
export function NavbarDivider({
  ...
  return (
    <div
      aria-hidden="true"
      {...props}
      className={twMerge(className, 'h-6 w-px bg-zinc-950/10 dark:bg-white/10')}
    />
  )
}
...
export function NavbarSpacer({
  ...
  return (
    <div
      aria-hidden="true"
      {...props}
      className={twMerge(className, '-ml-4 flex-1')}
    />
  )
}
...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  return (
    <span className={twMerge(className, 'relative')}>
      {current && (
        <motion.span
      ...
      {'href' in props ? (
        ...
        <Headless.Button
          {...props}
          className={twMerge('cursor-default', classes)}
          data-current={current ? 'true' : undefined}
          ref={ref}
        >
          <TouchTarget>{children}</TouchTarget>
...
export function NavbarLabel({
  ...
  return <span {...props} className={twMerge(className, 'truncate')} />
}
