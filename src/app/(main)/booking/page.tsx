...
import { bookingFeatures } from '@/components/sub-landing/booking/BookingFeatures'
  ...
  [
    {
      ...
      answer:
        'Inxtruc is a guide creation app designed to help Booking.com hosts streamline communication with guests. Create step-by-step guides for tasks like check-in, operating appliances, and exploring the local area to enhance your guest experience.',
    },
    {
      question: 'How do I share guides with my guests?',
      answer:
        'Once you’ve created a guide, you can share it via a link, QR code, or through your Booking.com messaging platform. Guests can easily access the guides anytime during their stay.',
    },
    {
